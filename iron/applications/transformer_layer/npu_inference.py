...
from iron.applications.transformer_layer.src.pattern_dataflow_blocks import (
    Block1QKVProjPattern,
    Block2MHAOutProjPattern,
    Block3AddNormFFNAddNormPattern,
)
from iron.applications.transformer_layer.src.pattern_gemm_sequences import (
...
def build_pattern(execution_mode: str, spec: TransformerLayerSpec):
    ...
    if execution_mode == "gemm_offload":
        return GemmOffloadPattern(spec)
