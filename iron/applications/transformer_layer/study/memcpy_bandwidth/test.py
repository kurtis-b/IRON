...
from iron.applications.transformer_layer.study.memcpy_bandwidth.cases import (
    iter_cases,
)
from iron.applications.transformer_layer.study.memcpy_bandwidth.run import (
    CSV_FIELDNAMES,
    main,
    merge_rows,
    mark_peak_rows,
...
def test_main_writes_csv_and_plots_from_monkeypatched_benchmarks(monkeypatch, tmp_path):
    monkeypatch.setattr(
        "iron.applications.transformer_layer.study.memcpy_bandwidth.run.require_npu_power_mode_turbo",
    ...
    monkeypatch.setattr(
        "iron.applications.transformer_layer.study.memcpy_bandwidth.run.benchmark_case",
        fake_benchmark_case,
    )
