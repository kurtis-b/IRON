...
from iron.applications.transformer_layer.study.memory_tile_staging.plot_staging_depth import (
    load_plot_rows,
    render_plot,
    write_canonical_plots,
)
from iron.applications.transformer_layer.study.memory_tile_staging.run import (
    STAGING_SEQUENCE_LENGTHS,
    build_selection_rows,
    main,
    supported_staging_depths,
)
from iron.applications.transformer_layer.study.memory_tile_staging.select import (
...
def test_build_selection_rows_sweeps_only_depth_and_computes_speedup(monkeypatch):
    ...
    monkeypatch.setattr(
        "iron.applications.transformer_layer.study.memory_tile_staging.run.benchmark_candidate",
