    ...
    *,
    ...
    if execution_mode == "offload":
        ...
        return {
            ...
            "npu_dispatch_count": 6 + 2 * workload.num_attention_heads,
    ...
    role_specs = (
        ...
        (
            "attn_scores",
            {
                ...
                "N": workload.seq_len,
                "batch_A": (workload.num_attention_heads, 1),
                "batch_B": (workload.num_attention_heads, 1),
                "batch_C": (workload.num_attention_heads, 0),
            },
            workload.num_attention_heads,
            False,
        ),
        (
            "attn_output",
            {
                ...
                "batch_A": (workload.num_attention_heads, 0),
                "batch_B": (workload.num_attention_heads, 1),
                "batch_C": (workload.num_attention_heads, 1),
            },
            workload.num_attention_heads,
            False,
        ),
    ...
    *,
    ...
    try:
        ...
        power_stats = _measure_power(
            lambda: operator.forward(reference["input"]),
