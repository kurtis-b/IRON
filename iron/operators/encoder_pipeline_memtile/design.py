...
from iron.operators.encoder_pipeline_memtile.debug_modes import (
    ADDNORM_DEBUG_DISABLED,
    ADDNORM_DEBUG_INPUT,
    ADDNORM_DEBUG_RESIDUAL,
)
from iron.operators.encoder_pipeline_memtile.mapping_validation import (
    find_ffn_layout,
    manhattan_distance,
)
...
def fused_mha(
    ...
    from iron.operators.encoder_pipeline_memtile import hooks as ln1_mode_hooks
