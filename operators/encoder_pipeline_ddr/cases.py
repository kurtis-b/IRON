...
DDR_CASES = [
    pytest.param(_case_with_default_opg(case), id=_case_name(_case_with_default_opg(case)))
...
@pytest.mark.parametrize("case", DDR_CASES)
def test_encoder_pipeline_ddr(case, aie_context):
