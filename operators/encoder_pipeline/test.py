...
def generate_test_params():
    return [
        pytest.param(
            ...
            1,
            1,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb",
        ),
        pytest.param(
            128,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_128seq_64d_12h_3072ffn_32q_64kv_96emb",
        ),
        pytest.param(
            256,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_256seq_64d_12h_3072ffn_32q_64kv_96emb",
        ),
        pytest.param(
            64,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_2ps",
        ),
        pytest.param(
            128,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_128seq_64d_12h_3072ffn_32q_64kv_96emb_2ps",
        ),
        pytest.param(
            256,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_256seq_64d_12h_3072ffn_32q_64kv_96emb_2ps",
        ),
        pytest.param(
            128,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_128seq_64d_12h_3072ffn_32q_64kv_96emb_4ps",
            marks=pytest.mark.xfail(
                strict=True,
                reason="true 4-way sequence-parallel full-pipeline placement does not fit on the current 8-column device",
            ),
        ),
        pytest.param(
            64,
            ...
            1,
            1,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_2ph",
        ),
        pytest.param(
            64,
            64,
            ...
            1,
            1,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_4ph",
        ),
        pytest.param(
            64,
            64,
            ...
            1,
            2,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_2pffn",
        ),
        pytest.param(
            64,
            64,
            ...
            1,
            2,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_2ph_2pffn",
        ),
        pytest.param(
            64,
            64,
            ...
            1,
            4,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_4pffn",
        ),
        pytest.param(
            64,
            64,
            ...
            1,
            4,
            id="encoder_pipeline_64seq_64d_12h_3072ffn_32q_64kv_96emb_2ph_4pffn",
        ),
    ]
