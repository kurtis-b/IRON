module {
  aie.device(npu2) {
    ...
    aie.memtile_row_store @outOProjAccum0(%tile_0_5, %mem_tile_4_1_0) {buffer_count = 2 : i32, compute_s2mm_channel = 1 : i32, memtile_egress_channel = 2 : i32, memtile_ingress_channel = 2 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    ...
    aie.memtile_row_store @ln1Replay(%tile_1_5, %mem_tile_5_1_1) {buffer_count = 2 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    ...
    aie.memtile_row_store @ffnDownAccum(%tile_6_5, %mem_tile_6_1_2) {buffer_count = 2 : i32, memtile_egress_channel = 2 : i32, memtile_ingress_channel = 2 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    ...
    %core_0_5 = aie.core(%tile_0_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_4 to %c12 step %c1_5 {
          %2 = aie.memtile_row_store.acquire @outOProjAccum0(Produce) : memref<32x64xbf16>
          func.call @zero_bf16_o_proj(%2) : (memref<32x64xbf16>) -> ()
          aie.memtile_row_store.release @outOProjAccum0(Produce)
        }
        %c0_6 = arith.constant 0 : index
        ...
        scf.for %arg1 = %c0_6 to %c12_7 step %c1_8 {
          ...
          scf.for %arg2 = %c0_13 to %c12_14 step %c1_15 {
            %4 = aie.memtile_row_store.acquire @outOProjAccum0(Consume) : memref<32x64xbf16>
            %5 = aie.objectfifo.acquire @memOW0(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            %7 = aie.memtile_row_store.acquire @outOProjAccum0(Produce) : memref<32x64xbf16>
            func.call @matmul_with_acc_bf16_bf16_o_proj(%3, %6, %4, %7) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>) -> ()
            aie.memtile_row_store.release @outOProjAccum0(Produce)
            aie.objectfifo.release @memOW0(Consume, 1)
            aie.memtile_row_store.release @outOProjAccum0(Consume)
          }
        ...
        scf.for %arg1 = %c0_9 to %c12_10 step %c1_11 {
          %2 = aie.memtile_row_store.acquire @outOProjAccum0(Consume) : memref<32x64xbf16>
          func.call @ln_calc_sum_sumsq(%2, %o_proj_stats_sum_0, %o_proj_stats_sumsq_0) : (memref<32x64xbf16>, memref<32xf32>, memref<32xf32>) -> ()
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_8 to %c46 step %c1_9 {
          ...
          scf.for %arg2 = %c0_13 to %c12_14 step %c1_15 {
            ...
            func.call @passThroughLine_o_proj(%2, %5, %c2048_i32_16) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.memtile_row_store.release @ln1Replay(Produce)
            aie.memtile_row_store.release @ln1Replay(Consume)
          }
        }
    ...
    %core_6_5 = aie.core(%tile_6_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_4 = arith.constant 1 : index
        scf.for %arg1 = %c0_3 to %c12 step %c1_4 {
          %2 = aie.memtile_row_store.acquire @ffnDownAccum(Produce) : memref<32x64xbf16>
          %3 = aie.objectfifo.acquire @memBDown(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
          func.call @ffn_matmul_init_bf16_bf16_down_proj(%1, %4, %2) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>) -> ()
          aie.objectfifo.release @memBDown(Consume, 1)
          aie.memtile_row_store.release @ffnDownAccum(Produce)
        }
        ...
        scf.for %arg1 = %c0_5 to %c47 step %c1_6 {
          ...
          %c1_12 = arith.constant 1 : index
          scf.for %arg2 = %c0_10 to %c12_11 step %c1_12 {
            %4 = aie.memtile_row_store.acquire @ffnDownAccum(Consume) : memref<32x64xbf16>
            %5 = aie.memtile_row_store.acquire @ffnDownAccum(Produce) : memref<32x64xbf16>
            %6 = aie.objectfifo.acquire @memBDown(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            func.call @ffn_matmul_with_acc_bf16_bf16_down_proj(%3, %7, %4, %5) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>) -> ()
            aie.objectfifo.release @memBDown(Consume, 1)
            aie.memtile_row_store.release @ffnDownAccum(Produce)
            aie.memtile_row_store.release @ffnDownAccum(Consume)
          }
          aie.objectfifo.release @ffnUpOut(Consume, 1)
        }
        %c0_7 = arith.constant 0 : index
