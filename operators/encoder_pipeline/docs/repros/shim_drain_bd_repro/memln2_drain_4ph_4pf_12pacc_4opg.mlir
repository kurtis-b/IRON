module {
  aie.device(npu2) {
    ...
    aie.memtile_row_store @outOProjAccum3(%tile_3_5, %mem_tile_0_1_0) {buffer_count = 2 : i32, compute_s2mm_channel = 1 : i32, memtile_egress_channel = 5 : i32, memtile_ingress_channel = 5 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    ...
    aie.memtile_row_store @ln1Replay(%tile_6_5, %mem_tile_3_1_1) {buffer_count = 2 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    ...
    aie.memtile_row_store @ffnDownAccum1(%tile_6_3, %mem_tile_5_1_2) {buffer_count = 2 : i32, memtile_egress_channel = 0 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    %mem_tile_7_1_3 = aie.tile(7, 1)
    aie.memtile_row_store @ffnDownAccum3(%tile_7_4, %mem_tile_7_1_3) {buffer_count = 2 : i32, memtile_egress_channel = 0 : i32, part_count = 12 : i32} : memref<32x64xbf16>
    ...
    %core_3_5 = aie.core(%tile_3_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_5 to %c12 step %c1_6 {
          %2 = aie.memtile_row_store.acquire @outOProjAccum3(Produce) : memref<32x64xbf16>
          func.call @zero_bf16_o_proj(%2) : (memref<32x64xbf16>) -> ()
          aie.memtile_row_store.release @outOProjAccum3(Produce)
        }
        %c0_7 = arith.constant 0 : index
        %c3 = arith.constant 3 : index
        %c1_8 = arith.constant 1 : index
        scf.for %arg1 = %c0_7 to %c3 step %c1_8 {
          ...
          scf.for %arg2 = %c0_13 to %c12_14 step %c1_15 {
            ...
            %8 = aie.memtile_row_store.acquire @outOProjAccum3(Consume) : memref<32x64xbf16>
            %9 = aie.memtile_row_store.acquire @outOProjAccum3(Produce) : memref<32x64xbf16>
            %c2048_i32_16 = arith.constant 2048 : i32
            func.call @eltwise_add_bf16_vector_o_proj(%8, %o_proj_partial_scratch_3, %9, %c2048_i32_16) : (memref<32x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.memtile_row_store.release @outOProjAccum3(Produce)
            aie.memtile_row_store.release @outOProjAccum3(Consume)
        ...
        scf.for %arg1 = %c0_9 to %c12_10 step %c1_11 {
          %2 = aie.memtile_row_store.acquire @outOProjAccum3(Consume) : memref<32x64xbf16>
          func.call @ln_calc_sum_sumsq(%2, %o_proj_stats_sum_3, %o_proj_stats_sumsq_3) : (memref<32x64xbf16>, memref<32xf32>, memref<32xf32>) -> ()
          %3 = aie.objectfifo.acquire @outOProjInput(Produce, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
          %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%2, %4, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
    ...
    %core_6_5 = aie.core(%tile_6_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_4 to %c12 step %c1_5 {
          ...
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %4 = aie.memtile_row_store.acquire @ln1Replay(Produce) : memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%3, %4, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
        ...
        scf.for %arg1 = %c0_6 to %c12_7 step %c1_8 {
          %2 = aie.memtile_row_store.acquire @ln1Replay(Consume) : memref<32x64xbf16>
          %3 = aie.memtile_row_store.acquire @ln1Replay(Produce) : memref<32x64xbf16>
          %c768_i32 = arith.constant 768 : i32
          func.call @fused_layer_norm_1outs(%2, %ln1_norm_sum_buffer, %ln1_norm_sumsq_buffer, %3, %c768_i32) : (memref<32x64xbf16>, memref<32xf32>, memref<32xf32>, memref<32x64xbf16>, i32) -> ()
          %4 = aie.objectfifo.acquire @ln1Norm(Produce, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
          %5 = aie.objectfifo.subview.access %4[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%3, %5, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
        ...
        scf.for %arg1 = %c0_9 to %c10 step %c1_10 {
          ...
          scf.for %arg2 = %c0_14 to %c12_15 step %c1_16 {
            %2 = aie.memtile_row_store.acquire @ln1Replay(Consume) : memref<32x64xbf16>
            %3 = aie.objectfifo.acquire @ln1Norm(Produce, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
            %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
            %c2048_i32 = arith.constant 2048 : i32
            func.call @passThroughLine_o_proj(%2, %4, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.objectfifo.release @ln1Norm(Produce, 1)
            %5 = aie.memtile_row_store.acquire @ln1Replay(Produce) : memref<32x64xbf16>
            %c2048_i32_17 = arith.constant 2048 : i32
            func.call @passThroughLine_o_proj(%2, %5, %c2048_i32_17) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.memtile_row_store.release @ln1Replay(Produce)
            aie.memtile_row_store.release @ln1Replay(Consume)
          }
        }
    ...
    %core_6_3 = aie.core(%tile_6_3) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_5 = arith.constant 1 : index
        scf.for %arg1 = %c0_4 to %c12 step %c1_5 {
          %2 = aie.memtile_row_store.acquire @ffnDownAccum1(Produce) : memref<32x64xbf16>
          %3 = aie.objectfifo.acquire @ffnDownGroup0(Consume, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
          %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%4, %2, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
          aie.objectfifo.release @ffnDownGroup0(Consume, 1)
          %5 = aie.objectfifo.acquire @memBDown1(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
          func.call @ffn_matmul_with_acc_bf16_bf16_down_proj(%1, %6, %2, %2) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>) -> ()
          aie.objectfifo.release @memBDown1(Consume, 1)
          aie.memtile_row_store.release @ffnDownAccum1(Produce)
        }
        ...
        scf.for %arg1 = %c0_6 to %c11 step %c1_7 {
          ...
          %c1_16 = arith.constant 1 : index
          scf.for %arg2 = %c0_14 to %c12_15 step %c1_16 {
            %4 = aie.memtile_row_store.acquire @ffnDownAccum1(Consume) : memref<32x64xbf16>
            %5 = aie.memtile_row_store.acquire @ffnDownAccum1(Produce) : memref<32x64xbf16>
            %6 = aie.objectfifo.acquire @ffnDownGroup0(Consume, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
            %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
            %c2048_i32 = arith.constant 2048 : i32
            func.call @passThroughLine_o_proj(%7, %5, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.objectfifo.release @ffnDownGroup0(Consume, 1)
            %8 = aie.objectfifo.acquire @memBDown1(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            func.call @ffn_matmul_with_acc_bf16_bf16_down_proj(%3, %9, %5, %5) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>) -> ()
            aie.objectfifo.release @memBDown1(Consume, 1)
            %c2048_i32_17 = arith.constant 2048 : i32
            func.call @eltwise_add_bf16_vector_o_proj(%5, %4, %5, %c2048_i32_17) : (memref<32x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.memtile_row_store.release @ffnDownAccum1(Produce)
            aie.memtile_row_store.release @ffnDownAccum1(Consume)
          }
          aie.objectfifo.release @ffnUpOut1(Consume, 1)
        }
        %c0_8 = arith.constant 0 : index
        ...
        scf.for %arg1 = %c0_8 to %c12_9 step %c1_10 {
          ...
          %4 = aie.memtile_row_store.acquire @ffnDownAccum1(Consume) : memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%4, %3, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
          %5 = aie.memtile_row_store.acquire @ffnDownAccum1(Produce) : memref<32x64xbf16>
          %c2048_i32_14 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%4, %5, %c2048_i32_14) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
          aie.memtile_row_store.release @ffnDownAccum1(Produce)
          aie.memtile_row_store.release @ffnDownAccum1(Consume)
        ...
        %c1_13 = arith.constant 1 : index
        scf.for %arg1 = %c0_11 to %c12_12 step %c1_13 {
          %2 = aie.memtile_row_store.acquire @ffnDownAccum1(Consume) : memref<32x64xbf16>
          %3 = aie.objectfifo.acquire @ffnDownOut0(Produce, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
          %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%2, %4, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
          aie.memtile_row_store.release @ffnDownAccum1(Consume)
    ...
    %core_7_4 = aie.core(%tile_7_4) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        %c1_5 = arith.constant 1 : index
        scf.for %arg1 = %c0_4 to %c12 step %c1_5 {
          %2 = aie.memtile_row_store.acquire @ffnDownAccum3(Produce) : memref<32x64xbf16>
          %3 = aie.objectfifo.acquire @ffnDownGroup2(Consume, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
          %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%4, %2, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
          aie.objectfifo.release @ffnDownGroup2(Consume, 1)
          %5 = aie.objectfifo.acquire @memBDown3(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
          %6 = aie.objectfifo.subview.access %5[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
          func.call @ffn_matmul_with_acc_bf16_bf16_down_proj(%1, %6, %2, %2) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>) -> ()
          aie.objectfifo.release @memBDown3(Consume, 1)
          aie.memtile_row_store.release @ffnDownAccum3(Produce)
        }
        ...
        scf.for %arg1 = %c0_6 to %c11 step %c1_7 {
          ...
          %c1_16 = arith.constant 1 : index
          scf.for %arg2 = %c0_14 to %c12_15 step %c1_16 {
            %4 = aie.memtile_row_store.acquire @ffnDownAccum3(Consume) : memref<32x64xbf16>
            %5 = aie.memtile_row_store.acquire @ffnDownAccum3(Produce) : memref<32x64xbf16>
            %6 = aie.objectfifo.acquire @ffnDownGroup2(Consume, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
            %7 = aie.objectfifo.subview.access %6[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
            %c2048_i32 = arith.constant 2048 : i32
            func.call @passThroughLine_o_proj(%7, %5, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.objectfifo.release @ffnDownGroup2(Consume, 1)
            %8 = aie.objectfifo.acquire @memBDown3(Consume, 1) : !aie.objectfifosubview<memref<64x64xbf16>>
            %9 = aie.objectfifo.subview.access %8[0] : !aie.objectfifosubview<memref<64x64xbf16>> -> memref<64x64xbf16>
            func.call @ffn_matmul_with_acc_bf16_bf16_down_proj(%3, %9, %5, %5) : (memref<32x64xbf16>, memref<64x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>) -> ()
            aie.objectfifo.release @memBDown3(Consume, 1)
            %c2048_i32_17 = arith.constant 2048 : i32
            func.call @eltwise_add_bf16_vector_o_proj(%5, %4, %5, %c2048_i32_17) : (memref<32x64xbf16>, memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
            aie.memtile_row_store.release @ffnDownAccum3(Produce)
            aie.memtile_row_store.release @ffnDownAccum3(Consume)
          }
          aie.objectfifo.release @ffnUpOut3(Consume, 1)
        }
        %c0_8 = arith.constant 0 : index
        ...
        %c1_13 = arith.constant 1 : index
        scf.for %arg1 = %c0_11 to %c12_12 step %c1_13 {
          %2 = aie.memtile_row_store.acquire @ffnDownAccum3(Consume) : memref<32x64xbf16>
          %3 = aie.objectfifo.acquire @ffnDownOut1(Produce, 1) : !aie.objectfifosubview<memref<32x64xbf16>>
          %4 = aie.objectfifo.subview.access %3[0] : !aie.objectfifosubview<memref<32x64xbf16>> -> memref<32x64xbf16>
          %c2048_i32 = arith.constant 2048 : i32
          func.call @passThroughLine_o_proj(%2, %4, %c2048_i32) : (memref<32x64xbf16>, memref<32x64xbf16>, i32) -> ()
          aie.memtile_row_store.release @ffnDownAccum3(Consume)
