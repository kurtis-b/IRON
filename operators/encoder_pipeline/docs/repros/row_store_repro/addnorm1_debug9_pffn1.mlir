module {
  aie.device(npu2) {
    ...
    aie.memtile_row_store @ln1Replay(%tile_6_5, %mem_tile_5_1) {part_count = 8 : i32} : memref<32x96xbf16>
    ...
    %core_6_5 = aie.core(%tile_6_5) {
      ...
      scf.for %arg0 = %c0 to %c9223372036854775807 step %c1 {
        ...
        scf.for %arg1 = %c0_0 to %c8 step %c1_1 {
          ...
          %1 = aie.objectfifo.subview.access %0[0] : !aie.objectfifosubview<memref<32x96xbf16>> -> memref<32x96xbf16>
          %2 = aie.memtile_row_store.acquire @ln1Replay(Produce) : memref<32x96xbf16>
          %c3072_i32 = arith.constant 3072 : i32
          func.call @passThroughLine_o_proj(%1, %2, %c3072_i32) : (memref<32x96xbf16>, memref<32x96xbf16>, i32) -> ()
          aie.memtile_row_store.release @ln1Replay(Produce)
        ...
        scf.for %arg1 = %c0_2 to %c8_3 step %c1_4 {
          %0 = aie.memtile_row_store.acquire @ln1Replay(Consume) : memref<32x96xbf16>
          %1 = aie.memtile_row_store.acquire @ln1Replay(Produce) : memref<32x96xbf16>
          %c3072_i32 = arith.constant 3072 : i32
          func.call @passThroughLine_o_proj(%0, %1, %c3072_i32) : (memref<32x96xbf16>, memref<32x96xbf16>, i32) -> ()
          %2 = aie.objectfifo.acquire @ln1Norm(Produce, 1) : !aie.objectfifosubview<memref<32x96xbf16>>
          %3 = aie.objectfifo.subview.access %2[0] : !aie.objectfifosubview<memref<32x96xbf16>> -> memref<32x96xbf16>
          %c3072_i32_10 = arith.constant 3072 : i32
          func.call @passThroughLine_o_proj(%1, %3, %c3072_i32_10) : (memref<32x96xbf16>, memref<32x96xbf16>, i32) -> ()
          aie.objectfifo.release @ln1Norm(Produce, 1)
          aie.memtile_row_store.release @ln1Replay(Produce)
          aie.memtile_row_store.release @ln1Replay(Consume)
        }
        %c0_5 = arith.constant 0 : index
        ...
        scf.for %arg1 = %c0_5 to %c30 step %c1_6 {
          ...
          scf.for %arg2 = %c0_10 to %c8_11 step %c1_12 {
            %0 = aie.memtile_row_store.acquire @ln1Replay(Consume) : memref<32x96xbf16>
            %1 = aie.objectfifo.acquire @ln1Norm(Produce, 1) : !aie.objectfifosubview<memref<32x96xbf16>>
            %2 = aie.objectfifo.subview.access %1[0] : !aie.objectfifosubview<memref<32x96xbf16>> -> memref<32x96xbf16>
            %c3072_i32 = arith.constant 3072 : i32
            func.call @passThroughLine_o_proj(%0, %2, %c3072_i32) : (memref<32x96xbf16>, memref<32x96xbf16>, i32) -> ()
            aie.objectfifo.release @ln1Norm(Produce, 1)
            %3 = aie.memtile_row_store.acquire @ln1Replay(Produce) : memref<32x96xbf16>
            %c3072_i32_13 = arith.constant 3072 : i32
            func.call @passThroughLine_o_proj(%0, %3, %c3072_i32_13) : (memref<32x96xbf16>, memref<32x96xbf16>, i32) -> ()
            aie.memtile_row_store.release @ln1Replay(Produce)
            aie.memtile_row_store.release @ln1Replay(Consume)
          }
        }
