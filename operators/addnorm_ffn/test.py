...
def generate_test_params(extensive=False):
    if TEST_BERT:
        params = [
            ...
            (8 * 4, 96, 96, 2, 8, 96, 96, 0, 1, 1, 1, None, 0),  # All compute executed
            ...
            # (512, 768, 3072, 4, 64, 48, 96, 0, 4, 1, 1, None, 0),
            # (512, 768, 3072, 4, 64, 48, 96, 0, 8, 1, 1, None, 0),
            # (512, 768, 3072, 4, 64, 48, 96, 0, 1, 4, 1, None, 0),
            # (512, 768, 3072, 4, 64, 48, 96, 0, 1, 1, 2, None, 0),
            # # Scaling within 8 columns (total cores utilized vary)
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 8, 2, None, 0),
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 4, 4, None, 0),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 8, 2, None, 0),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 4, 4, None, 0),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 8, 2, None, 0),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 4, 4, None, 0),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 8, 2, None, 0),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 4, 4, None, 0),
            # # up_proj only
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 8, 2, 0, 0),
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 4, 4, 0, 0),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 8, 2, 0, 0),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 4, 4, 0, 0),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 8, 2, 0, 0),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 4, 4, 0, 0),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 8, 2, 0, 0),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 4, 4, 0, 0),
            # # down_proj only
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 8, 2, 1, 0),
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 4, 4, 1, 0),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 8, 2, 1, 0),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 4, 4, 1, 0),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 8, 2, 1, 0),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 4, 4, 1, 0),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 8, 2, 1, 0),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 4, 4, 1, 0),
            # # GeLU fused with down projection
            # # baseline
            # (64, 48, 96, 2, 64, 48, 96, 0, 1, 1, 1, None, 1),
            # # M scaled up from baseline
            # (64 * 4, 48, 96, 2, 64, 48, 96, 0, 1, 1, 1, None, 1),
            # # K scaled up from baseline
            # (64, 48 * 4, 96, 2, 64, 48, 96, 0, 1, 1, 1, None, 1),
            # # N scaled up from baseline
            ...
            # # Scaling within 4 columns (total cores utilized vary)
            # (512, 768, 3072, 4, 64, 48, 96, 0, 4, 1, 1, None, 1),
            # (512, 768, 3072, 4, 64, 48, 96, 0, 8, 1, 1, None, 1),
            # (512, 768, 3072, 4, 64, 48, 96, 0, 1, 4, 1, None, 1),
            # (512, 768, 3072, 4, 64, 48, 96, 0, 1, 1, 2, None, 1),
            # # Scaling within 8 columns (total cores utilized vary)
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 8, 2, None, 1),
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 4, 4, None, 1),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 8, 2, None, 1),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 4, 4, None, 1),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 8, 2, None, 1),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 4, 4, None, 1),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 8, 2, None, 1),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 4, 4, None, 1),
            # # up_proj only
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 8, 2, 0, 1),
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 4, 4, 0, 1),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 8, 2, 0, 1),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 4, 4, 0, 1),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 8, 2, 0, 1),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 4, 4, 0, 1),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 8, 2, 0, 1),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 4, 4, 0, 1),
            # # down_proj only
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 8, 2, 1, 1),
            # (512, 768, 3072, 8, 64, 48, 96, 0, 8, 4, 4, 1, 1),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 8, 2, 1, 1),
            # (512, 768, 3072, 8, 32, 96, 48, 0, 8, 4, 4, 1, 1),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 8, 2, 1, 1),
            # (512, 768, 3072, 8, 64, 64, 64, 0, 6, 4, 4, 1, 1),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 8, 2, 1, 1),
            # (512, 768, 3072, 8, 32, 128, 32, 0, 6, 4, 4, 1, 1),
        ]
        extensive_params = []
    else:
        params = []
